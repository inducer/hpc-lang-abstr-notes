...
#+BEAMER_HEADER: \def\classurl{https://relate.cs.illinois.edu/course/cs598apk-f18/}
...
** Notes
  ...
  :RELATE_TREE_LINK: https://andreask.cs.illinois.edu/cs598apk-f18/notes.pdf
  :END:
...
#+LATEX: \demonote{C $\to$ Assembly mapping from \url{https://github.com/ynh/cpp-to-assembly}}
...
#+LATEX: \demo{intro/Pipeline Performance Mystery}
...
Color represents achieved bandwith:
- Red: high
- Blue: low
...
Q: Estimate epxected throughput for =saxpy= on an architecture with caches.
...
- Divergent control flow
  - Masking
  - Reconvergence
- Indirect adressing: gather/scatter
#+LATEX: \end{hidden}
...
#+LATEX: \begin{hidden}
- Indepdendent forward progress of all threads is not guaranteed: no.
...
- Goal: Common intermediate represenation ("IR") for all GPU-facing code (Vulkan, OpenCL)
